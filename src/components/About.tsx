            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-300 leading-relaxed">
                            Além do desenvolvimento, tenho experiência em vendas automotivas e sou apaixonado em criar inovações tecnologicas 
                            que ajudam a melhorar a gestão de empresas, consequentemente, aumentando a produtividade e a eficiência dos negócios.
                        </p>
                        <p className="text-lg text-gray-300 leading-relaxed">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {technologies.map((tech, index) => (
                                <motion.div
                                    ...
                                    className="bg-gray-700 p-4 rounded-lg border border-gray-600 hover:border-cyan-400 transition-all"
                                >
